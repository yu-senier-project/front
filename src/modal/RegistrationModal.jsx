  ...
  switch(modalStep){
    ...
    case 1:
      content = (
        <div className="register-modal">
          <div className="header">
            <button className="close-button" onClick={() => { setModalStep(modalStep - 1); }}><h1>←</h1></button>
            <button className="close-button" onClick={handleClose}>
              <CloseButton />
            </button>
          </div>
          ...
          <Button text={"다음"} size={"Large"} onClick={() => { setModalStep(2); }} />
        </div>
      );
      break;
    case 2:
      content = (
        <div className="register-modal">
          ...
          <Input size="Large" placeholder={"아이디"} onChange={handleInputChange} value={`${formData.userNickName}`} name={"userNickName"} />
